...
if __name__ == '__main__':
    output_root = 'output_dev'
    pred_versions = [
        os.path.join('v48', 'post_process_stage2'),
        os.path.join('v50', 'post_process_stage2'),
        os.path.join('v51', 'post_process_stage2'),
        'e3',
        'v50'
    ]
    prefered_version = os.path.join('v48', 'post_process_stage2')
    ensemble_version = 'e5'
