...
if __name__ == '__main__':
    convert_parquet_data_to_json(
        ...
        max_length=500,
        output_train_file_name='data_gen_content_train_stage2_subword_deberta_v3_500.json',
        output_val_file_name='data_gen_content_val_stage2_subword_deberta_v3_500.json',
        output_test_file_name='data_gen_content_test_stage2_subword_deberta_v3_500.json'
    )
